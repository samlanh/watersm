...
public function init()
    ...
    public function indexAction()
    {
    	...
    	$columns=array("WORK_TYPE","DATE","STATUS");
    	$link=array(
		...
		if ($this->getRequest()->isPost()){
			try {
				...
				if(isset($data['save_close'])){
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS", "/dailywork/project/index");
					
				}else {
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS", "/dailywork/project/add");
				}
			}
			catch (Exception $e){
