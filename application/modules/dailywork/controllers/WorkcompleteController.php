		...
		if ($this->getRequest()->isPost()){
			try {
				...
				if(isset($data['save_close'])){
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS", "/dailywork/workcomplete");
				}else{
					Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS", "/dailywork/workcomplete/add");
				}
			}
			catch (Exception $e){
